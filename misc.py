...
def getLoader(datasetName, dataroot, originalSize, imageSize, batchSize=64, workers=4,
    ...
    if datasetName == 'rain_data':
        from data.rain_data import Rain_Data as commonDataset
        import transforms.transform as transforms
    elif datasetName == 'rain_data_val':
        from data.rain_data_val import Rain_Data_val as commonDataset
        import transforms.transform as transforms
    if split == 'train':
