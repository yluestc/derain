...
class ShuffleTransformerNet(nn.Module):
    ...
    def forward(self, x):
        ...
        t = self.upsample_layers(t2)
        t = self.sigmoid(t)
        t2_g1 = t2[:, 2, :, :]   #these code show the features of different groups in group convolution
        t2_g2 = t2[:, 46, :, :]
        t2_g3 = t2[:, 90, :, :]
        t2_g1 = t2_g1.unsqueeze(1)
        t2_g2 = t2_g2.unsqueeze(1)
        t2_g3 = t2_g3.unsqueeze(1)
#        x = self.softmax2d(x)
#        x = x[:, 0, :, :]
#        x = x.unsqueeze(1)
        return t, t2_g1, t2_g2, t2_g3
#        return t
